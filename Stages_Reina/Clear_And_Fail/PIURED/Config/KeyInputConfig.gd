...
class KeyInputConfig:
    ...
    var _lpad:Dictionary
    var _rpad:Dictionary

    # lpad/rpad: dictionary containing the keys 'dl', 'ul', 'c','ur','dr' which contain the values of the inputs you want to listen for.
    func constructor(lpad:Dictionary, rpad:Dictionary):
        self._lpad = lpad ;
        self._rpad = rpad ;